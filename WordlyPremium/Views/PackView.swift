                ...
                VStack(spacing: 25) {
                    ...
                    VStack(spacing: -17) {
                        CardButtonExtended(
                            ...
                            isGradient: false, hasIcon: true, color: Color.azure
                        )
                        CardButtonExtended(
                        ...
                        CardButtonExtended(
                            cardTitle: "Test", icon: "book", isGradient: false,
                    ...
                    VStack(alignment: .leading) {
                        ...
                        LazyVStack(alignment: .leading) {
                            ForEach(pack.flashcards.indices, id: \.self) { index in
                                VStack(alignment: .leading) {
                                    HStack {
                                    ...
                                    .padding(.bottom, index == pack.flashcards.count - 1 ? 15 : 0)
