...
struct MockData {
    static func getMockPacks() -> [PackEntity] {
        return [
            PackEntity(name: "Spanish Pack", isAIGenerated: false, langFrom: LanguageType.english, langTo: LanguageType.italian, flashcards: [
            ...
            PackEntity(name: "French Pack", isAIGenerated: true, langFrom: LanguageType.english, langTo: LanguageType.italian, flashcards: [
            ...
            PackEntity(name: "German Pack", isAIGenerated: false, langFrom: LanguageType.english, langTo: LanguageType.italian, flashcards: [
            ...
            PackEntity(name: "Italian Pack", isAIGenerated: true, langFrom: LanguageType.english, langTo: LanguageType.italian, flashcards: [
            ...
            PackEntity(name: "Japanese Pack", isAIGenerated: false, langFrom: LanguageType.english, langTo: LanguageType.italian, flashcards: [
            ...
            PackEntity(name: "Russian Pack", isAIGenerated: true, langFrom: LanguageType.english, langTo: LanguageType.italian, flashcards: [
